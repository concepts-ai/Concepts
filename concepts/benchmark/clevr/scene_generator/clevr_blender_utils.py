...
def get_camera_coords(cam, pos):
    ...
    Returns: a tuple of: (px, py, pz).
        px and py give 2D image-space coordinates; pz gives depth in the range [-1, 1]
    """
...
def set_layer(obj, layer_idx):
    ...
    Args:
        obj: object to move to a new layer
        layer_idx: index of the layer to move the object to
    """
    # Set the target layer to True first because an object must always be on at least one layer.
...
def add_object(object_dir, name, scale, loc, theta=0):
    ...
    Args:
        object_dir: absolute path to directory containing blend file
        name: name of the blend file and object
...
def load_materials(material_dir):
    ...
    Args:
        material_dir: path to directory containing the materials
    """
...
def add_material(name, **properties):
    ...
    Args:
        name: name of the material to use
        properties: keyword args mapping shader property names to values
    """
