...
from concepts.dm.pdsketch.predicate import Predicate, flatten_expression, split_simple_bool
...
from concepts.dm.pdsketch.strips.strips_expression import SPredicateName, SProposition, SState, SStateCompatible, make_sproposition

from concepts.dm.pdsketch.strips.strips_grounded_expression import GSBoolOutputExpression, GSVariableAssignmentExpression, GSBoolForwardDiffReturn
from concepts.dm.pdsketch.strips.strips_grounded_expression import GS_OPTIMISTIC_STATIC_OBJECT, GSOptimisticStaticObjectType
from concepts.dm.pdsketch.strips.strips_grounded_expression import GSBoolConstantExpression, GSSimpleBoolExpression, gs_compose_bool_expressions, gs_is_empty_bool_expression
from concepts.dm.pdsketch.strips.strips_grounded_expression import GSSimpleBoolAssignExpression, GSConditionalAssignExpression, GStripsDerivedPredicate
...
class GStripsOperator(object):
    ...
    raw_operator: OperatorApplier
    """The raw operator.
    Note that since the strips operator is grounded, the raw operator is the :class:`concepts.dm.pdsketch.operator.OperatorApplier` instance."""
    ...
    def applicable(self, state: Union[SState, Set[SProposition]]) -> Union[bool, GSBoolForwardDiffReturn]:
        ...
        Returns:
            True if the operator is applicable, False otherwise. When the `FORWARD_DIFF` mode is enabled for :class:`~concepts.dm.pdsketch.strips.strips_grounded_expression.GSBoolExpression`,
            this function will return a :class:`~concepts.dm.pdsketch.strips.strips_grounded_expression.GSBoolForwardDiffReturn` object.
        """
    ...
    def filter_propositions(self, propositions: Set[SProposition], state: Optional[SState] = None) -> 'GStripsOperator':
        ...
        by actions. See :meth:`~concepts.dm.pdsketch.strips.strips_grounded_expression.GSExpression.filter_propositions` for more details.
...
class GStripsRegressionRule(object):
    def __init__(self, precondition: GSBoolOutputExpression, GSBoolOutputExpression, goal: GSBoolOutputExpression, body: Sequence[Union[GStripsOperator, GStripsAchieveExpression]]):
        self.precondition = precondition
        self.goal = goal
...
class GStripsTranslatorBase(object):
    ...
    def compile_regression_rule(self, op: RegressionRuleApplier, state: State) -> GStripsRegressionRule:
        raise NotImplementedError()
    ...
    def compile_task(
        ...
        Args:
            ...
            regression_rules: the list of regression rules. If not specified, all regression rules in the domain will be used.
