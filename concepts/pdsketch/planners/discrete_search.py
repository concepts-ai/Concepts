...
from concepts.dsl.dsl_types import PyObjValueType, NamedTensorValueType
...
def prepare_search(
    ...
    if actions is None:
        actions = gen_all_grounded_actions(executor, state, continuous_values, action_filter=action_filter)
    ...
    for depth in range(max_depth):
        ...
        with jacinle.cond_with(pbar, verbose):
            ...
            for s, traj in states:
                ...
                if goal_test(executor, s, goal_expr, traj):
                    if verbose:
