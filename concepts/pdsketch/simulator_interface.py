...
from concepts.pdsketch.executor import PythonFunctionRef, PDSketchExecutor
from concepts.pdsketch.domain import State

__all__ = ['PDSketchSimulatorInterface']
...
class PDSketchSimulatorInterface(object):
    ...
    def __init__(self, executor: PDSketchExecutor):
        ...
        Args:
            executor: the :class:`~concepts.pdsketch.executor.PDSketchExecutor` instance for grounding action parameters.
        """
