...
- Brute-force sampling-based CSP solver. See :mod:`concepts.pdsketch.csp_solvers.brute_force_sampling`.
- DPLL-sampling-based CSP solver (a generalization of the DPLL algorithm to mixed discrete-continuous CSPs). See :mod:`concepts.pdsketch.csp_solvers.dpll_sampling`.
"""
